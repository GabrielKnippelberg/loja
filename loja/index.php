...
<html lang="pt-br">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
        <header>
            <center><img src="imagens/logo.png" width="10%" height="10%"/></center>
        </header>
                        ...
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-hearder py-3">
                                ...
                                <div class="form-group">
                                    <label>Login</label>
                                    <input type="text" class="form-control" name="login" placeholder="Insira o nome" required/>
                                    <br/>
                                    <label>Senha</label>
                                    <input type="password" class="form-control" name="senha" placeholder="Insira o e-mail" required/>
                                    <br/>
        ...
        <footer>
            <hr/>
            <center><p style = "font-family:Garamond;">
